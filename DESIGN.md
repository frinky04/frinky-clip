...
- Default to a 900 × 600 window, minimum 720 × 480, with the native title bar supplying the app name. The lanes have fixed heights and the viewport takes the spare height; the footer keeps a fixed height including one message line.
