...
#include <atomic>
namespace clip {
// Include adjoining same-session segments for AAC decoder warm-up and the
// audio packet crossing the out point. Call before protecting source files.
...
// trimmed to the sample. Pass export_sources()'s read-ahead spans when
// available. `progress`, when given, receives 0..1. Throws on
